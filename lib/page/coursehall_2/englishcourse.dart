...
class _EnglishCourse extends State {
  ...
  Widget build(BuildContext context) {
    const String downloadLink = "https://UPPSKILL.com";
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title:
            const Text('English Course', style: TextStyle(color: Colors.white)),
        actions: [
          ...
          child: Column(
            ...
            children: [
              ...
              const YoutubePlayerWidget(
                  'https://youtu.be/GMBYezA0t_8?si=Sga9mRLPWKW8A9jM'),
              const SizedBox(height: 20),
              EpisodeListItem(
                episodeTitle: 'Episode 1:  perhitungan kimia / stoikiometri',
                onPressed: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const YoutubePlayerWidget(
                              'https://www.youtube.com/watch?v=GMBYezA0t_8')));
                },
              ),
              EpisodeListItem(
                episodeTitle:
                    'Episode 2: Menghitung massa dan volume zat pada persamaan reaksi',
                onPressed: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const YoutubePlayerWidget(
                              'https://www.youtube.com/watch?v=hdkJr_qrSgQ')));
                },
              ),
              EpisodeListItem(
                episodeTitle: 'Episode 3:  persentase komposisi/massa',
                onPressed: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const YoutubePlayerWidget(
                              'https://www.youtube.com/watch?v=QX_TreTPLeE')));
                },
              ),
              const SizedBox(height: 20),
              const Text(
