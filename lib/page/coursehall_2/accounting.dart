...
class AccountingCourse extends StatefulWidget {
  const AccountingCourse({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Accounting Course',
          ...
          child: Column(
            ...
            children: [
              const YoutubePlayerWidget(
                  'https://youtu.be/jZvNTIAi78I?si=gJQB0Al6U4qBa1Et'), // Link Video course youtube
              ...
              Column(
                ...
                children: [
                  ListTile(
                    title: const Text(
                      'Episode 1: Belajar Mekanika ternyata mudah loh!',
                        ...
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) => const YoutubePlayerWidget(
                                    'https://youtu.be/jZvNTIAi78I?si=gJQB0Al6U4qBa1Et')));
                      },
                    ...
                    trailing: ElevatedButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) => const YoutubePlayerWidget(
                                    'https://youtu.be/E5bQPrKAmTc?si=zJQruHLPE2MdASTT')));
                      },
                      child: const Text('Watch Now',
                          style: TextStyle(fontSize: 12, color: Colors.white)),
                    ),
